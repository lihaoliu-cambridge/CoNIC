...
def get_multi_r2(true, pred, fold=0):
    ...
    print("r2_list: " + str(r2_list).split("multi_r2")[-1])
    with open("/home/ll610/Onepiece/code_cs138/github/CoNIC/ensemble_record_fold_{}.txt".format(str(fold)), "a") as text_file:
        text_file.write("r2_list: " + str(r2_list).split("multi_r2")[-1] + "\n")
    # print("r2_list: " + str(r2_list).split("multi_r2")[-1])
    # with open("/home/ll610/Onepiece/code_cs138/github/CoNIC/hovernet_experimental_record.txt", "a") as text_file:
    #     text_file.write("r2_list: " + str(r2_list).split("multi_r2")[-1] + "\n")
